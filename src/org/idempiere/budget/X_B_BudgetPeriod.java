...
/** Generated Model for B_BudgetPeriod
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_B_BudgetPeriod extends PO implements I_B_BudgetPeriod, I_Persistent 
{
    ...
    public X_B_BudgetPeriod (Properties ctx, int B_BudgetPeriod_ID, String trxName)
    {
      super (ctx, B_BudgetPeriod_ID, trxName);
      /** if (B_BudgetPeriod_ID == 0)
        {
			setDocAction (null);
// CO
			setDocStatus (null);
...
// N
    ...
    /** Load Constructor */
    public X_B_BudgetPeriod (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_B_BudgetPeriod[")
        .append(get_ID()).append("]");
      return sb.toString();
    }

	/** Set Budget Period.
		@param B_BudgetPeriod_ID Budget Period	  */
	...
	public I_B_BudgetYear getB_BudgetYear() throws RuntimeException
    {
		return (I_B_BudgetYear)MTable.get(getCtx(), I_B_BudgetYear.Table_Name)
			.getPO(getB_BudgetYear_ID(), get_TrxName());	}

	/** Set Budget Year.
		@param B_BudgetYear_ID Budget Year	  */
